...
Endpoint untuk membuat akun baru.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="authentication-POSTapi-login">
                                <a href="#authentication-POSTapi-login">Login User

Login dan mendapatkan token Sanctum.</a>
                            </li>
                                                                        </ul>
                            </ul>
...
Menampilkan seluruh kategori.</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="products">
                    <a href="#products">Products</a>
                                ...
                                <a href="#products-GETapi-products">List Produk

Menampilkan daftar produk dengan pagination dan search.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="products-POSTapi-products">
                                <a href="#products-POSTapi-products">Tambah Produk

Menambahkan produk baru.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="products-GETapi-products--id-">
                                <a href="#products-GETapi-products--id-">Detail Produk

Menampilkan detail produk beserta kategori.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="products-PUTapi-products--id-">
                                <a href="#products-PUTapi-products--id-">Update Produk

Memperbarui data produk.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="products-DELETEapi-products--id-">
                                <a href="#products-DELETEapi-products--id-">Hapus Produk

Menghapus produk berdasarkan ID.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
Endpoint untuk membuat akun baru.</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Nama user. Example: <code>Budi</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Email user. Example: <code>budi@gmail.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
Login dan mendapatkan token Sanctum.</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Email user. Example: <code>admin@gmail.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
Menampilkan seluruh kategori.</h2>
...
<p>Example: <code>application/json</code></p>
                ...
                <h1 id="products">Products</h1>
                                ...
                                <h2 id="products-GETapi-products">List Produk

Menampilkan daftar produk dengan pagination dan search.</h2>
...
<i>optional</i> &nbsp;
 &nbsp;
    ...
    <br>
<p>Nama produk yang dicari. Example: <code>laptop</code></p>
            </div>
                </form>

                    <h2 id="products-POSTapi-products">Tambah Produk

Menambahkan produk baru.</h2>
...
<div class="bash-example">
    ...
    --form "description=Laptop gaming terbaru"\
    --form "price=12000000"\
    --form "image=@C:\Users\Teuku Raka\AppData\Local\Temp\phpEA7.tmp" </code></pre></div>
...
body.append('description', 'Laptop gaming terbaru');
body.append('price', '12000000');
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               value="Laptop gaming terbaru"
               data-component="body">
    <br>
<p>Deskripsi produk. Example: <code>Laptop gaming terbaru</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Harga produk. Example: <code>12000000</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Gambar produk. Example: <code>C:\Users\Teuku Raka\AppData\Local\Temp\phpEA7.tmp</code></p>
        </div>
        </form>

                    <h2 id="products-GETapi-products--id-">Detail Produk

Menampilkan detail produk beserta kategori.</h2>
...
<p>The ID of the product. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="products-PUTapi-products--id-">Update Produk

Memperbarui data produk.</h2>
...
<div class="bash-example">
    ...
    --form "price=17"\
    --form "image=@C:\Users\Teuku Raka\AppData\Local\Temp\php1455.tmp" </code></pre></div>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>ID kategori. Example: <code>17</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>name</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Nama produk. Example: <code>consequatur</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>description</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Harga produk. Example: <code>17</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>image</code></b>&nbsp;&nbsp;
<small>file</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Gambar produk. Example: <code>C:\Users\Teuku Raka\AppData\Local\Temp\php1455.tmp</code></p>
        </div>
        </form>

                    <h2 id="products-DELETEapi-products--id-">Hapus Produk

Menghapus produk berdasarkan ID.</h2>
